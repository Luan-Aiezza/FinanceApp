...
//                                        get: { viewModel.transferAmounts[goal.id] ?? "" },
//                                        set: { viewModel.updateTransferAmount(for: goal.id, amount: $0) }
//                                    ))
//                                    .textFieldStyle(RoundedBorderTextFieldStyle())
//                                    .keyboardType(.numberPad)
//                                    
//                                    Button(action: {
//                                        if let amount = Int(viewModel.transferAmounts[goal.id] ?? "") {
//                                            viewModel.addCoinsToGoal(goalId: goal.id, amount: amount)
//                                            viewModel.transferAmounts[goal.id] = "" // Limpar o campo após adicionar
//                                        }
//                                    }) {
//                                        Text("Add to Goal")
//                                    }
//                                    .buttonStyle(.borderedProminent)
//                                    .padding(.leading, 10)
//                                    .disabled(!viewModel.isTransferAmountValid(goalId: goal.id))
//                                }
//                                .padding(.top, 10)
//
//                                .padding(.top, 10)
